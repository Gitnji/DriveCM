...
<div class="mx-auto max-w-2xl">
    <div class="rounded-xl border border-success/20 bg-success/5 p-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-neutral">Student enrolled</h1>
                <p class="mt-0.5 text-sm text-neutral/60">{{ $application->name }} now has access.</p>
            </div>
        </div>
        ...
        <div class="mt-6 rounded-lg border border-accent/30 bg-accent/5 p-4">
            ...
            <p class="mt-1 text-xs text-neutral/70">
                This page is shown only once. Refresh and the password is gone forever.
                Pass these credentials to the student through a secure channel.
            </p>
